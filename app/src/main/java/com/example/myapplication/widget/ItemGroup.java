...
public class ItemGroup extends FrameLayout {
    ...
    public void flashContext(String newcontext)
    {
        contentEdt.setText(newcontext);
    }

    //初始化View
    private void initView(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.layout_personinfo_item, null);
